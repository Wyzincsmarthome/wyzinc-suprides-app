diff --git a/run_suprides_sync.py b/run_suprides_sync.py
index 9c7f3d18f000fa125749aa3794931b84aa5013ed..4fb480ce355676deaa957731312e9d126fd6682d 100644
--- a/run_suprides_sync.py
+++ b/run_suprides_sync.py
@@ -1,19 +1,21 @@
