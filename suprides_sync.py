...
+            # Já atingimos o limite de ofertas mas continuamos a contar itens
+            # para refletir a dimensão real do catálogo observado.
+            continue
+
...
+                log.exception("calc_final_price falhou para sku=%s cost=%s: %s", sku, price_cost, exc)
                 final_price = None
